...
@pytest.mark.parametrize(
    ...
    [
        # Happy Paths
        (5, {"name": "foo", "price": 10.0, "is_offer": True}, 200, {"item_id": 5, "name": "foo", "price": 10.0, "is_offer": True}),
        (5, {"name": "bar", "price": 20.0}, 200, {"item_id": 5, "name": "bar", "price": 20.0, "is_offer": None}),
        # Bad Paths
        (5, {"price": 10.0, "is_offer": True}, 422, None),  # Missing name
        (5, {"name": "foo", "is_offer": True}, 422, None),  # Missing price
        (5, {"name": "foo", "price": "ten", "is_offer": True}, 422, None),  # Invalid price type
    ],
)
